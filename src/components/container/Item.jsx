...
const Item = ({id, pictureUrl, title, description, price}) => 
                <div className="card item-card d-inline-block items">
                    ...
                    <div className="card-body">
                        ...
                        <Link to={`item/${id}`} className="btn btn-primary"><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-basket3" viewBox="0 0 16 16">
